...
def serialize_authorization(record: Authorization):
    return {
        ...
        "assigned_approver_name": (record.assigned_approver.full_name or record.assigned_approver.email) if record.assigned_approver else None,
        "requested_by_user_id": record.requested_by_user_id,
        "requested_by_name": (record.requested_by.full_name or record.requested_by.email) if record.requested_by else None,
        "resolved_by_user_id": record.resolved_by_user_id,
        "resolved_by_name": (record.resolved_by.full_name or record.resolved_by.email) if record.resolved_by else None,
        "title": record.title,
